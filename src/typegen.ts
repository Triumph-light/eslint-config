...
export type ConfigNames = 'tl/global-ignores' | 'tl/gitignore' | 'tl/comments/recommended' | 'tl/comments' | 'tl/js/recommended' | 'tl/js' | 'tl/imports' | 'tl/global-ignores' | 'tl/gitignore' | 'tl/comments/recommended' | 'tl/comments' | 'tl/js/recommended' | 'tl/js' | 'tl/imports' | 'tl/typescript__typescript-eslint/base' | 'tl/typescript__typescript-eslint/eslint-recommended' | 'tl/typescript__typescript-eslint/recommended' | 'tl/typescript' | 'tl/typescript/dts-rules' | 'tl/typescript/cjs-rules' | 'tl/sort/imports' | 'tl/yaml/setup' | 'tl/yaml/rules' | 'tl/json' | 'tl/sort/package.json' | 'tl/sort/tsconfig' | 'tl/sort/pnpm-workspace' | 'tl/prettier' | 'tl/vue/typescript__typescript-eslint/base' | 'tl/vue/typescript__typescript-eslint/eslint-recommended' | 'tl/vue/typescript__typescript-eslint/recommended' | 'tl/vue/typescript' | 'tl/vue' | 'tl/vue/reactivity-transform'
